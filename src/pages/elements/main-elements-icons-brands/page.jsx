...
const metadata = {
  title:
    "Element Page Header Icons Brands || Forli &mdash; One & Multi Page Reactjs Creative Template",
  description: "Forli &mdash; One & Multi Page Reactjs Creative Template",
};
export default function ElementPageIconsBrands() {
  return (
    <>
                ...
                <div className="row mb-n30">
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">fa-android</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">fa-behance</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">fa-blogger</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">fa-codepen</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">fa-dribbble</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">fa-dropbox</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">fa-hubspot</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">fa-jsfiddle</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">fa-linkedin</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">fa-shopify</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">fa-spotify</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">fa-twitter</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">fa-vimeo-v</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">fa-whatsapp</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">fa-youtube</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                </div>
