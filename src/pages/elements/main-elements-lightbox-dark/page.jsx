...
const metadata = {
  title:
    "Element Page Lightbox Dark || Forli &mdash; One & Multi Page Reactjs Creative Template",
  description: "Forli &mdash; One & Multi Page Reactjs Creative Template",
};
export default function ElementPageLightboxDark() {
  return (
    <>
