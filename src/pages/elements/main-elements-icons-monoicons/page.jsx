...
const metadata = {
  title:
    "Element Page Icons Monicons || Forli &mdash; One & Multi Page Reactjs Creative Template",
  description: "Forli &mdash; One & Multi Page Reactjs Creative Template",
};
export default function ElementPageIconsMonicons() {
  return (
    <>
                    ...
                    <div className="text-center">
                      ...
                      <div className="mb-30">
                        <div className="highlight">
                          <pre>
                            <code className="html">
                              &lt;i className="mi-heart"&gt;&lt;/i&gt; mi-heart
                            </code>
                          </pre>
                        </div>
                        <p>
                ...
                <div className="row mb-n30">
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-archive</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-arrow-up</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-bookmark</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-calendar</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-caret-up</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-comment</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-compass</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-computer</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-database</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-document</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-download</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-edit-alt</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-eye-off</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-favorite</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-filter-1</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-link-alt</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-location</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-log-out</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-message</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-minimize</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-previous</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-refresh</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-reorder</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-settings</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-shuffle</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-speakers</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-sunrise</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-two-rows</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-user-add</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-warning</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  ...
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-zoom-in</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                  {/* Icon Box Item */}
                  <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-30 d-flex align-items-stretch">
                    <div className="icons-example-box">
                      ...
                      <div className="icons-example-box-class">mi-zoom-out</div>
                    </div>
                  </div>
                  {/* End Icon Box Item */}
                </div>
