...
const metadata = {
  title:
    "Element Page Header White || Forli &mdash; One & Multi Page Reactjs Creative Template",
  description: "Forli &mdash; One & Multi Page Reactjs Creative Template",
};
export default function ElementPageHeaderWhite() {
  return (
    <>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-8 offset-md-2">
                        <h1 className="hs-title-1 mb-20">
                          ...
                          >
                            <AnimatedText text="Header White" />
                          </span>
                        </h1>
                        <div className="row">
