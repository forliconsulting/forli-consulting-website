                    ...
                    >
                      <div className="features-2-item pt-sm-40 pb-sm-40">
                        ...
                        <div className="features-2-descr">
                          ...
                          nisi dictum magna, ut viverra massa ex sit amet nulla.
                        </div>
                      </div>
                    </div>
                    {/* End Steps Items */}
                    ...
                    >
                      <div className="features-2-item pt-sm-40 pb-sm-40">
                        ...
                        <div className="features-2-descr">
                          ...
                          libero lacus accumsan erat, quis ultrices risus urna a
                          lectus.
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="row mt-n30">
                    ...
                    >
                      <div className="alt-features-item box-shadow text-center mt-30">
                        ...
                        <div className="alt-features-descr">
                          Fusce aliquet quam eget neque ultrices elementum felis
                          id arcu blandit sagittis.
                        </div>
                      </div>
                    </div>
                    {/* End Feature Item */}
                    ...
                    >
                      <div className="alt-features-item box-shadow text-center mt-30">
                        ...
                        <h4 className="alt-features-title">Premium Support</h4>
                        <div className="alt-features-descr">
