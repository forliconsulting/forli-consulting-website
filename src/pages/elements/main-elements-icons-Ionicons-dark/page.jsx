...
const metadata = {
  title:
    "Element Page Icons Lonicons Dark || Forli &mdash; One & Multi Page Reactjs Creative Template",
  description: "Forli &mdash; One & Multi Page Reactjs Creative Template",
};
export default function ElementPageIconsLoniconsDark() {
  return (
    <>
                ...
                <div className="container relative">
                  <div className="row">
                    <div className="col-md-8 offset-md-2 mb-30">
                      <div className="text-center">
                        <p>
                          You can use a set of 180+ Ionicons icon pack. Open
                          this file in HTML code editor and copy SVG code of the
                          icon below. Use the icon number to find choosen icon
                          in the HTML code.
                        </p>
                      </div>
                    </div>
