...
const metadata = {
  title:
    "Modern About Dark || Forli &mdash; One & Multi Page Reactjs Creative Template",
  description: "Forli &mdash; One & Multi Page Reactjs Creative Template",
};
export default function ModernAboutPageDark() {
  return (
    <>
        ...
        <div className="dark-mode">
          <div className="page bg-dark-1" id="top">
            ...
            <main id="main">
              ...
              <section
                className="page-section bg-dark-1 light-content pb-0"
                id="about"
              >
                <div className="container position-relative">
                  <div
                  ...
                  >
                    ...
                    creating beautiful digital experiences and products. We are
                    an award winning group specializing in branding, design and
