...
const metadata = {
  title:
    "Strong Portfolio Single Dark || Forli &mdash; One & Multi Page Reactjs Creative Template",
  description: "Forli &mdash; One & Multi Page Reactjs Creative Template",
};
export default function StrongPortfolioSinglePageDark() {
                    ...
                    <div className="row mb-80 mb-sm-40">
                      ...
                      <div className="col-md-6">
                        ...
                        <p className="mb-0">
                          ...
                          ipsum sit ullamcorper pulvinar neque porttitor.
                          Integere lectus. Praesent sede nisi eleifend fermum
                          orci amet, iaculis libero. Donec vel ultricies purus
                          quam.
                        </p>
                      </div>
                ...
                <>
                  ...
                  <div className="work-navigation bg-dark-1 light-content clearfix">
                    ...
                    <a href="#" className="work-all">
                      <span>
                        <i className="mi-close size-24 align-middle" /> All
                        works
                      </span>
                    </a>
                    <Link
                      to={`/main-portfolio-single-3/1`}
                      className="work-next"
                    >
                      <span>
                        Next{" "}
