...
const metadata = {
  title:
    "Elegant Portfolio Single || Forli &mdash; One & Multi Page Reactjs Creative Template",
  description: "Forli &mdash; One & Multi Page Reactjs Creative Template",
};
export default function ElegantPortfolioSinglePage() {
        ...
        <div className="page" id="top">
          ...
          <main id="main">
                ...
                <div className="container relative">
                  <div className="row mb-80 mb-sm-40">
                    ...
                    <div className="col-md-6">
                      <h2 className="section-title-small mb-20">Description</h2>
                      <hr className="mb-20" />
            ...
            <>
              ...
              {/* End Divider */}
              {/* Work Navigation */}
              <div className="work-navigation clearfix z-index-1 position-relative">
